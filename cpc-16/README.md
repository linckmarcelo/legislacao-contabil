---
identificador: "CPC 16 (R1)"
tipo: "CPC"
numero: "16"
revisao: "R1"
titulo: "Estoques"
correlacao_ifrs: "IAS 2"
fonte_arquivo: "cpc16r1.pdf"
sha256_16: "b78bd34da5010237"
ementa: "O objetivo deste Pronunciamento é estabelecer o tratamento contábil para os estoques. A questão fundamental na contabilização dos estoques é quanto ao valor do custo a ser reconhecido como ativo e mantido nos registros até que as respectivas receitas sejam reconhecidas. Este Pronunciamento proporciona orientação sobre a determinação do valor de custo dos estoques e sobre o seu subsequente reconhecimento como despesa em resultado, incluindo qualquer redução ao valor realizável líquido. Também pro"
---
...
<a id="item-24"></a>
**24.** A identificação específica do custo significa que são atribuídos custos específicos a itens identificados do estoque. Este é o tratamento apropriado para itens que sejam segregados para um projeto específico, independentemente de eles terem sido comprados ou produzidos.
...
<a id="item-35"></a>
**35.** Alguns itens de estoques podem ser transferidos para outras contas do ativo, como, por exemplo, estoques usados como componentes de ativos imobilizados de construção própria.
...
<a id="item-37--anterior-007"></a>
> _(Item 37 — redação anterior, superada por revisão)_  
> A informação relativa a valores contábeis registrados nas diferentes classificações de estoques e a proporção de alterações nesses ativos é útil para os usuários das demonstrações contábeis.
