# Catálogo de Normas Contábeis Brasileiras

> **Versão:** 1.0 · **Atualizado em:** 2026-09-17 · **Fontes oficiais:** [CFC](https://cfc.org.br/tecnica/normas-brasileiras-de-contabilidade/) · [CPC](http://www.cpc.org.br/CPC/Documentos-Emitidos/Pronunciamentos)

> **Cobertura:** 187 normas (2 já indexadas no repo, 178 pendentes, 7 revogadas)

Renderização humana do arquivo estruturado [`normas-contabeis.json`](./normas-contabeis.json). Esta é a versão para leitura direta no GitHub — a versão canônica para consulta programática (pela `skill-contador`) é o JSON.

**Legenda:**

- ✅ = texto integral indexado no repo (`no_repo: true`)
- ⬜ = ainda a converter via `legislacao-pdf-para-markdown` (`no_repo: false`)
- ⛔ = norma revogada

---

## 1. NBC TG — Normas Brasileiras de Contabilidade, Técnica Geral

Espelham os CPCs. Aplicáveis a entidades sujeitas ao regime completo.
...
| NBC TG 11 | CPC 11 | Contratos de Seguro | ⛔ (rev. NBC TG 50 (CPC 50)) |
...
| NBC TG 17 | CPC 17 (R1) | Contratos de Construção | ⛔ (rev. NBC TG 47 (CPC 47)) |
...
| NBC TG 30 | CPC 30 (R1) | Receitas | ⛔ (rev. NBC TG 47 (CPC 47)) |
...
| NBC TG 38 | CPC 38 | Instrumentos Financeiros: Reconhecimento e Mensuração | ⛔ (rev. NBC TG 48 (CPC 48)) |
| NBC TG 39 | CPC 39 | Instrumentos Financeiros: Apresentação | ⛔ (rev. NBC TG 48 (CPC 48)) |
| NBC TG 40 | CPC 40 | Instrumentos Financeiros: Evidenciação | ⛔ (rev. NBC TG 48 (CPC 48)) |
| NBC TG 41 | CPC 41 | Resultado por Ação | ⬜ |
...
## 3. ITG — Interpretações Técnicas Gerais

| Código | Título | Status |
|---|---|---|
| ITG 02 | Entidade Coberta por Regime Próprio de Previdência Social | ⬜ |
| ITG 04 | Aplicação Inicial ao Ativo Biológico e ao Produto Agrícola | ⬜ |
| ITG 07 | Incorporação Imobiliária | ⬜ |
...
| ITG 10 | Aplicação Inicial ao Ativo Imobilizado e à Propriedade para Investimento | ⬜ |
| ITG 11 | Recebimento em Transferência de Ativos dos Clientes | ⬜ |
| ITG 2000 | Escrituração Contábil | ⬜ |
| ITG 2001 | Contribuintes Individuais do Instituto Nacional do Seguro Social | ⬜ |
| ITG 2002 | Entidades sem Finalidade de Lucros | ⬜ |
| ITG 2003 | Entidades Desportivas Profissionais | ⬜ |
| ITG 2004 | Entidades Cooperativas | ⛔ (rev. NBC TG 1004) |

## 4. ICPC — Interpretações do CPC
...
| ICPC 05 | Pagamento Baseado em Ações - Transações de Ações do Grupo e em Tesouraria | ⬜ |
...
| ICPC 13 | Direitos a Participações Decorrentes de Fundos de Desativação, Restauração e Recuperação Ambiental | ⬜ |
...
| OCPC 06 | Apresentação de Informações Financeiras Pró-Forma | ⬜ |
| OCPC 07 | Evidenciação na Divulgação dos Relatórios Contábil-Financeiros de Propósito Geral | ⬜ |
| OCPC 08 | Reconhecimento de Determinados Ativos e Passivos nos Relatórios Contábil-Financeiros para Fins Gerais | ⬜ |
| OCPC 09 | Ganho por Compra Vantajosa | ⬜ |

## 6. CTG — Comunicados Técnicos Gerais

| Código | Título | Status |
|---|---|---|
| CTG 01 | Entidades Cooperativas | ⬜ |
| CTG 02 | Escrituração Contábil Simplificada para Microempresa e Empresa de Pequeno Porte | ⬜ |
| CTG 03 | Adoção Antecipada dos CPCs 47 e 48 | ⬜ |
| CTG 04 | Aplicação da NBC TG 1000 e ITG 1000 pelas Entidades | ⬜ |
| CTG 06 | Aspectos Contábeis Relacionados à Reforma Tributária (LC 214/2025 e correlatos) | ⬜ |
| CTG 2000 | Escrituração Contábil | ⬜ |
| CTG 2001 | Definição de Tratamento Contábil das Contribuições Recebidas pelas Entidades sem Finalidade de Lucros | ⬜ |
| CTG 2002 | Demonstrações Contábeis das Cooperativas | ⬜ |
| CTG 2003 | Demonstrações Contábeis das Entidades Desportivas Profissionais | ⬜ |

## 7. NBC TSP — Normas do Setor Público
...
| NBC TSP 04 | Estoques | ⬜ |
| NBC TSP 05 | Contratos de Concessão de Serviços Públicos pelo Concedente | ⬜ |
...
| NBC TSP 14 | Divulgação sobre Partes Relacionadas | ⬜ |
| NBC TSP 15 | Benefícios a Empregados | ⬜ |
| NBC TSP 16 | Custos de Empréstimos | ⬜ |
| NBC TSP 17 | Investimento em Coligada e em Controlada | ⬜ |
| NBC TSP 18 | Empreendimento Controlado em Conjunto | ⬜ |
| NBC TSP 19 | Combinações no Setor Público | ⬜ |
| NBC TSP 20 | Demonstrações Consolidadas | ⬜ |
| NBC TSP 21 | Demonstrações Separadas | ⬜ |
| NBC TSP 22 | Divulgação de Participações em Outras Entidades | ⬜ |
| NBC TSP 23 | Ativos Biológicos e Produtos Agrícolas | ⬜ |
| NBC TSP 24 | Instrumentos Financeiros | ⬜ |
| NBC TSP 25 | Políticas Contábeis, Mudança de Estimativa e Retificação de Erro | ⬜ |
| NBC TSP 26 | Efeitos das Mudanças nas Taxas de Câmbio e Conversão de Demonstrações Contábeis | ⬜ |
| NBC TSP 27 | Demonstração Intermediária | ⬜ |
...
### Evidência de Auditoria (500–599)
...
| NBC TA 510 | Trabalhos Iniciais de Auditoria - Saldos Iniciais | ⬜ |
| NBC TA 520 | Procedimentos Analíticos | ⬜ |
| NBC TA 530 | Amostragem em Auditoria | ⬜ |
| NBC TA 540 | Auditoria de Estimativas Contábeis e Divulgações Correspondentes | ⬜ |
| NBC TA 550 | Partes Relacionadas | ⬜ |
| NBC TA 560 | Eventos Subsequentes | ⬜ |
| NBC TA 570 | Continuidade Operacional | ⬜ |
| NBC TA 580 | Representações Formais | ⬜ |

### Trabalho de Terceiros (600–699)
...
| NBC TA 805 | Considerações Especiais - Auditorias de Quadros Isolados das Demonstrações Contábeis e de Elementos, Contas ou Itens Específicos | ⬜ |
| NBC TA 810 | Trabalhos para a Apresentação de Relatórios sobre Demonstrações Contábeis Condensadas | ⬜ |

## 9. NBC TR / NBC TO / NBC TSC — Revisão, Asseguração e Correlatos

| Código | Família | Título | Status |
|---|---|---|---|
| NBC TR 2400 | NBC TR | Trabalhos de Revisão de Demonstrações Contábeis Passadas | ⬜ |
| NBC TR 2410 | NBC TR | Revisão de Informações Intermediárias Executada pelo Auditor da Entidade | ⬜ |
| NBC TO 3000 | NBC TO | Trabalhos de Asseguração Diferente de Auditoria e Revisão | ⬜ |
| NBC TO 3402 | NBC TO | Relatórios de Asseguração sobre Controles em Organização Prestadora de Serviços | ⬜ |
| NBC TO 3410 | NBC TO | Trabalhos de Asseguração sobre Declarações de Gases de Efeito Estufa | ⬜ |
| NBC TO 3420 | NBC TO | Trabalhos de Asseguração para Emissão de Relatório sobre Compilação de Informações Financeiras Pro Forma | ⬜ |
| NBC TSC 4400 | NBC TSC | Trabalhos de Procedimentos Previamente Acordados sobre Informações Contábeis | ⬜ |
| NBC TSC 4410 | NBC TSC | Trabalhos de Compilação de Informações Contábeis | ⬜ |

## 10. NBC TP / NBC PP — Perícia

| Código | Família | Título | Status |
|---|---|---|---|
| NBC TP 01 | NBC TP | Perícia Contábil | ⬜ |
| NBC PP 01 | NBC PP | Perito Contábil | ⬜ |
| NBC PP 02 | NBC PP | Exame de Qualificação Técnica para Perito Contábil | ⬜ |

## 11. NBC PG / NBC PA — Normas Profissionais
...
| NBC PA 03 | Exame de Qualificação Técnica para Registro no Cadastro Nacional de Auditores Independentes (CNAI) | ⬜ |
| NBC PA 290 | Independência - Trabalhos de Auditoria e Revisão | ⬜ |
| NBC PA 291 | Independência - Outros Trabalhos de Asseguração | ⬜ |
| NBC PA 400 | Revisão Externa de Qualidade pelos Pares | ⬜ |

---

*Este catálogo é uma renderização do arquivo estruturado `normas-contabeis.json`. Para atualizações, edite o JSON e rode `python gera-md.py` a partir desta pasta.*
